...
public class HeadPoseEstimator {
    ...
    static {
        ...
        final Point3 dummyPoint = new Point3(
                -165.f / 3,
                0.f / 3,
                145.f / 3
        );
    ...
    public static void estimate(final Mat src, final List<Point> points) {
        ...
        matOfImagePoints.fromList(Stream.concat(points.stream(), Stream.of(dummy2DPoint))
        ...
        // Solving PnP
        int solutionsCount = Calib3d.solveP3P(model,
                matOfImagePoints,
                camMat,
                distCoeff,
                rotationsList,
